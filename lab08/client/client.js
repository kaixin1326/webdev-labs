    ...
    connection.onmessage = e => {
        ...
        if (data["type"] === "login" || data["type"] === "disconnect") {
            ...
            if (username === data["username"]) {
                qs('#chat').innerHTML += `<div style ="text-align:right"><strong>You:</strong> ${data["text"]}</div> `
            } else {
                qs('#chat').innerHTML += `<div><strong>${data["username"]}:</strong> ${data["text"]}</div > `
            }
        }
        // data.get("username") = qs('#users-list').innerHTML;
        /***********************************************************
